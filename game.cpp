...
{
	scene = new Scene();
	scene->GetCamera()->Translate( vec3( 0, 2.5, -2.5 ) );
	scene->GetCamera()->Rotate( vec3( 0.0, 0, 0.0 ) );
...
void Game::CreateBoxEnvironment()
{
	...
	sphere1->position = point3(1, 1.5, 3);
	scene->Add(sphere1);
